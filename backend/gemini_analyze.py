    ...
    if has_layout_ctx:
        ...
        if is_window_side:
            ...
            if anchor_not_present:
                ...
                if anchor_pct < anchor_cutoff or (anchor_pct < anchor_hard_floor and qual_wrong):
                    forced_focal = True
                else:
                    soft_notes.append(

            ...
            if _auto_focal in _SIDE_EN:
                ...
                if _auto_focal == _entr_side:
                    _auto_choice += (
                        ...
                        "and TV-console visual centres differ by no more than 4% of the image height, "
                        "sit on ONE straight cross-room viewing line, and their seat/screen normals point "
                        "at each other. Never solve this by pulling the TV back toward the entrance. The "
                        "sofa must NOT remain level with the entrance door while the TV sits deeper in "
                        "the room. "
                    )
            else:
                _auto_choice = (
...
_RETRY_FLAG_FIX_EN = {
    ...
    "focal_anchor_misaligned_with_sofa":
        "The sofa and TV/media console were NOT on the same cross-room viewing axis. Keep the TV "
        "safely past the entrance, and move the SOFA deeper along the opposite wall until their visual "
        "centres differ by no more than 4% of image height. Their centres must align on ONE straight "
        "line and the sofa-seat / TV-screen normals must point at each other. Never move the TV back "
        "toward the entrance; do not leave the sofa level with the entrance while the TV sits deeper.",

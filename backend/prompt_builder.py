            ...
            if zoning.get("_layout_conservative"):
                ...
                if _auto_focal == _entr_side:
                    _auto_choice += (
                        ...
                        "seat normal and TV-screen normal point directly at each other on one clear "
...
_RETRY_FLAG_FIX_EN = {
    ...
    "focal_anchor_misaligned_with_sofa":
        "The sofa and TV/media console were NOT facing each other. Keep the TV safely past the entrance, "
        "then move or rotate the SOFA so the sofa-seat normal and TV-screen normal point directly at "
        "each other on one clear cross-room sightline. The seated viewer must look at the TV, never the "
        "entrance. Do not pull the TV back toward the door.",
